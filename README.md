...
Oie! Sou desenvolvedor fullstack e graduado em Sistemas de Informação pela UFVJM. Utilizo tecnologias como React, JavaScript, TypeScript, Express (Node.js) e FastAPI (Python).
